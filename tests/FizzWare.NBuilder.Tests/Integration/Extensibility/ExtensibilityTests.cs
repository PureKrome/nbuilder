...
namespace FizzWare.NBuilder.Tests.Integration.Extensibility
{
    public class ExtensibilityTests
    {
        ...
        {
            var builderSettings = new RepositoryBuilderSetup().DoSetup();
        ...
        {
            var builderSettings = new RepositoryBuilderSetup().DoSetup();
            builderSettings.SetPropertyNamerFor<Product>(
                new CustomProductPropertyNamer(new ReflectionUtil(), builderSettings));
