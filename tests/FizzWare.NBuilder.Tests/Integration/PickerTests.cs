    ...
    public class PickerTests
    {
        ...
        public void ShouldBeAbleToPickUsingBetweenPickerConstraint()
        {
            ...
            var products = Builder<MyClass>
                .CreateListOfSize(10)
                .All()
                .With(x => x.SimpleClasses = Pick<SimpleClass>.UniqueRandomList(With.Between(1, 5).Elements)
                    .From(simpleClasses)).Build();
        ...
        public void ShouldBeAbleToPickUsingExactlyConstraint()
        {
            ...
            var products = Builder<MyClass>
                .CreateListOfSize(10)
                .All()
                .With(x => x.SimpleClasses = Pick<SimpleClass>.UniqueRandomList(With.Exactly(1).Elements)
                    .From(simpleClasses)).Build();
