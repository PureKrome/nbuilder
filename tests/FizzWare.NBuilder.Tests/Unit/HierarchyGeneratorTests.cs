...
namespace FizzWare.NBuilder.Tests.Unit
{
    ...
    public class HierarchyGeneratorTests
    {
        ...
        private readonly int minCategories;
        private readonly int maxCategories;
        private readonly IList<MyHierarchicalClass> sourceList;
        private readonly int categoryCount;
        private HierarchyGenerator<MyHierarchicalClass> hierarchyGenerator;
        private readonly Func<MyHierarchicalClass, string, string> namingMethod;
        ...
        public void HierarchyGeneratorConstructor_SourceListNotBigEnough_Complains()
        {
            ...
            Assert.Throws<ArgumentException>(
                () =>
                    hierarchyGenerator =
                        new HierarchyGenerator<MyHierarchicalClass>(sourceList, null, numberOfRoots, depth,
                            minCategories,
        ...
        public void ShouldAddChildren()
        {
            ...
            hierarchyGenerator = new HierarchyGenerator<MyHierarchicalClass>(sourceList, (x, y) => x.AddChild(y),
                numberOfRoots, depth, minCategories, maxCategories, randomGenerator, namingMethod, null);
        ...
        public void ShouldGenerateTheCorrectNumberOfRoots()
        {
            ...
            hierarchyGenerator = new HierarchyGenerator<MyHierarchicalClass>(sourceList, (x, y) => x.AddChild(y),
                numberOfRoots, depth, minCategories, maxCategories, randomGenerator, namingMethod, null);
            var hierarchy = hierarchyGenerator.Generate();
        ...
        public void ShouldTryToPersistIfPersistenceServiceSupplied()
        {
            ...
            hierarchyGenerator = new HierarchyGenerator<MyHierarchicalClass>(sourceList, (x, y) => x.AddChild(y),
                numberOfRoots, depth, minCategories, maxCategories, randomGenerator, namingMethod, persistenceService);
            hierarchyGenerator.Generate();
        }
    }
}