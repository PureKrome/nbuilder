...
namespace FizzWare.NBuilder.Tests.Unit.Dates
{
    ...
    public class DatesTests
    {
        ...
        public void Can_use_Today_class()
        {
            ...
            time.ShouldBe(new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 09, 01, 00));
        }
        ...
        public void Can_use_Today_class_with_seconds()
        {
            ...
            time.ShouldBe(new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 09, 01, 05));
        }
        ...
        public void Can_use_The()
        {
            ...
            for (int i = 1; i < 13; i++)
            {
                for (int j = 1; j < 32; j++)
                {
                    ...
                    date.ShouldBe(new DateTime(year, i, j));
                }
            }
        }
        ...
        public void Can_use_At_extension_method()
        {
            ...
            dateWithTime.TimeOfDay.ShouldBe(new TimeSpan(0, 09, 31, 0));
        }
        ...
        public void Can_use_At_extension_method_with_seconds()
        {
            ...
            dateWithTime.TimeOfDay.ShouldBe(new TimeSpan(0, 23, 20, 15));
        }
    }
