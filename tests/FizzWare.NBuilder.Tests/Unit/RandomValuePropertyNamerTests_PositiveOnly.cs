...
namespace FizzWare.NBuilder.Tests.Unit
{
    ...
    {
        public RandomValuePropertyNamerTests_PositiveOnly()
        {
...

            {
                ...
                generator.Next(0, long.MaxValue).Returns(1);
                ...
                generator.Next(0, float.MaxValue).Returns(1);
                generator.Next(0, double.MaxValue).Returns(1);
                generator.Next(0, decimal.MaxValue).Returns(1);
