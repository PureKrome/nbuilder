...
namespace FizzWare.NBuilder.Tests.Unit
{
    public class ExtensibileRandomValuePropertyNamerTests
    {
        ...
        private readonly ExtensibleRandomValuePropertyNamer target;
        ...
        public void adding_handler_for_complex_type_names_using_the_added_handler()
        {
            ...
            target.NameWith(SimpleClassBuilder.New.Build);
        ...
        [Fact]
        public void
            nullable_members_are_set_using_the_specifc_nullable_handler_and_not_the_non_nullable_one_for_te_same_type()
        {
            var myClass = new MyClass();
        ...
        [Fact]
        public void
            when_naming_with_handler_that_takes_memeberinfo_parameter__the_member_info_parameter_will_be_received()
        {
            var foo = new MyClass();
