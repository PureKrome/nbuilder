...
namespace FizzWare.NBuilder.Tests.Unit
{
    ...
    public class ListBuilderExtensionsTests
    {
        ...
        public void LastRangeShouldBeTheCapacityMinusTheRangeSizeAndOneLessThanTheCapacity()
        {
            ...
            listBuilderImpl
                .AddDeclaration(Arg.Is<RangeDeclaration<MyClass>>(y => y.Start == startIndex && y.End == endIndex))
                .Returns(rangeDeclaration);

            var declaration = ListBuilderExtensions.TheLast(listBuilderImpl, 10);
            declaration.ShouldBe(rangeDeclaration);
        }

        [Fact]
        public void RandomAmountMustBeOneOrGreater()
        {
            Assert.Throws<ArgumentException>(() => { ListBuilderExtensions.Random(listBuilderImpl, 0); });
        }
        ...
        public void RandomAmountShouldBeLessThanListCapacity()
        {
            ...
            Assert.Throws<ArgumentException>(() => { ListBuilderExtensions.Random(listBuilderImpl, 11); });
        }
        ...
        public void RandomCanReturnDeclarationForASectionOfTheList()
        {
            ...
            listBuilderImpl.Capacity.Returns(listSize);
            listBuilderImpl.AddDeclaration(Arg.Is<RandomDeclaration<MyClass>>(y => y.Start == start && y.End == end))
                .Returns(randomDeclaration);
        ...
        public void RandomShouldReturnRandomDeclarationOfRangeOfWholeList()
        {
            ...
            listBuilderImpl.BuilderSettings.Returns(new BuilderSettings());
            listBuilderImpl.Capacity.Returns(listSize);
            listBuilderImpl.AddDeclaration(Arg.Is<RandomDeclaration<MyClass>>(y => y.Start == 0 && y.End == end))
                .Returns(randomDeclaration);
        ...
        {
            Assert.Throws<ArgumentException>(() => { ListBuilderExtensions.Section(listBuilderImpl, -1, 10); });
        }
        ...
        public void ShouldBeAbleToUseSection()
        {
            ...
            listBuilderImpl.CreateObjectBuilder().Returns((IObjectBuilder<MyClass>) null);
            listBuilderImpl.AddDeclaration(Arg.Is<RangeDeclaration<MyClass>>(y => y.Start == 10 && y.End == 19))
                .Returns(rangeDeclaration);
        ...
        {
            var declarationQueue = Substitute.For<IDeclarationQueue<MyClass>>();
            var rangeDeclaration = new RangeDeclaration<MyClass>(listBuilderImpl, null, 10, 19);
            ...
            listBuilderImpl.BuilderSettings.Returns(new BuilderSettings());
            var thePreviousDeclaration =
                (RangeDeclaration<MyClass>) ListBuilderExtensions.ThePrevious(listBuilderImpl, 10);
        ...
        {
            var declarationQueue = Substitute.For<IDeclarationQueue<MyClass>>();
            var rangeDeclaration = new RangeDeclaration<MyClass>(listBuilderImpl, null, 0, 9);
        ...
        {
            Assert.Throws<ArgumentException>(() => { ListBuilderExtensions.TheFirst(listBuilderImpl, 0); });
        }
        ...
        public void TheFirstAmountShouldBeLessThanListCapacity()
        {
            ...
            Assert.Throws<ArgumentException>(() => { ListBuilderExtensions.TheFirst(listBuilderImpl, 11); });
        }
        ...
        public void TheFirstShouldReturnARangeDeclaration()
        {
            ...
            listBuilderImpl.CreateObjectBuilder().Returns((IObjectBuilder<MyClass>) null);
            listBuilderImpl.AddDeclaration(Arg.Is<RangeDeclaration<MyClass>>(y => y.Start == 0 && y.End == 9))
                .Returns(rangeDeclaration);
        ...
        {
            Assert.Throws<ArgumentException>(() => { ListBuilderExtensions.TheLast(listBuilderImpl, 0); });
        }
        ...
        public void TheLastAmountShouldBeLessThanListCapacity()
        {
            ...
            Assert.Throws<ArgumentException>(() => { ListBuilderExtensions.TheLast(listBuilderImpl, 11); });
        }
        ...
        public void TheNextAmountShouldBeGreaterThanOne()
        {
            ...
            Assert.Throws<ArgumentException>(() => { ListBuilderExtensions.TheNext(listBuilderImpl, 0); });
        }
