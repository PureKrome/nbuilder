...
namespace FizzWare.NBuilder.Tests.Unit
{
    public class SequentialPropertyNamerSequenceTests
    {
        ...
        public void SetValuesOfAllIn_ClassWithNullCharConst_CharConstantIsNotSetByNamer()
        {
            ...
            var list = new List<MyClassWithCharConst> {new MyClassWithCharConst()};
            ...
            // TODO: No idea what to port for this.
        ...
        {
            var prop0 = typeof(MyClass).GetField("InternalFieldInt", BindingFlags.NonPublic | BindingFlags.Instance)
                .GetValue(theList[0]);
            var prop9 = typeof(MyClass).GetField("InternalFieldInt", BindingFlags.NonPublic | BindingFlags.Instance)
                .GetValue(theList[9]);
        ...
        {
            var prop0 = typeof(MyClass).GetField("PrivateFieldInt", BindingFlags.NonPublic | BindingFlags.Instance)
                .GetValue(theList[0]);
            var prop9 = typeof(MyClass).GetField("PrivateFieldInt", BindingFlags.NonPublic | BindingFlags.Instance)
                .GetValue(theList[9]);
        ...
        {
            var prop0 = typeof(MyClass).GetProperty("PrivateInt", BindingFlags.NonPublic | BindingFlags.Instance)
                .GetValue(theList[0], null);
            var prop9 = typeof(MyClass).GetProperty("PrivateInt", BindingFlags.NonPublic | BindingFlags.Instance)
                .GetValue(theList[9], null);
        ...
        {
            var prop0 = typeof(MyClass).GetField("ProtectedFieldInt", BindingFlags.NonPublic | BindingFlags.Instance)
                .GetValue(theList[0]);
            var prop9 = typeof(MyClass).GetField("ProtectedFieldInt", BindingFlags.NonPublic | BindingFlags.Instance)
                .GetValue(theList[9]);
        ...
        {
            var prop0 = typeof(MyClass).GetProperty("ProtectedInt", BindingFlags.NonPublic | BindingFlags.Instance)
                .GetValue(theList[0], null);
            var prop9 = typeof(MyClass).GetProperty("ProtectedInt", BindingFlags.NonPublic | BindingFlags.Instance)
                .GetValue(theList[9], null);
        ...
        [Fact]
        [Description(
            "The desired behaviour is byte properties should be given the values 1...255, 1...255, 1...255 repeatedly")]
